  ...
  <div class="row-fluid">
    <div class="span6">
      <div class="widget-box">
        ...
        <c:choose>
  <c:when test="${requestScope.Id_page eq 'InsertQuestion' }">
  <input type="hidden" name="Id_page" value="InsertQuestion" >
   

        <div class="control-group" id="myText">
              
            </div>

                                <div class="control-group" >
              <label class="control-label">Nom Question:</label>
              <div class="controls">
                <input type="text" class="span11" name="title" required/>
                                <input type="hidden" class="span11" name="title" value="${requestScope.id_test }" required/>
        ...
        <div id="ajout"></div>
            ...
            <div class="form-actions">
                   <form>
<input type="button" name="choix" id="checkbox" value="Add" onclick="addInput()"/>
</form>
