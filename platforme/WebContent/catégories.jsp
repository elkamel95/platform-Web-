    ...
    <div class="row-fluid">
      <div class="span12">
        ...
        <div class="widget-box">
          ...
          <c:choose>                  <c:when test="${requestScope.Id_page eq 'ViewSousCategories' }">
           ...
           <button class="btn btn-success dropdown-toggle" type="submit" name="id_role" value="1" >Sous Categories Formation</button> 
                <input type="hidden" name="Id_page" value="ViewSousCategories"/>
         ...
         <button class="btn btn-success dropdown-toggle" type="submit" name="id_role" value="2" >Sous Categories Recrutement</button> 
      <input type="hidden" name="Id_page" value="ViewSousCategories"/>
           </form> 
            </td>
            </tr>
            ...
            <c:when test="${requestScope.Id_page eq 'ViewCategories' }">
             <table>
            <tr>
            <td>
         <button class="btn btn-success dropdown-toggle" type="submit" name="Id_page" value="InsertCategories" >Insert Categories </button> 
           ...
           <button class="btn btn-success dropdown-toggle" type="submit" name="id_role" value="1" > Categories Formation</button> 
                <input type="hidden" name="Id_page" value="ViewCategories"/>
         ...
         <button class="btn btn-success dropdown-toggle" type="submit" name="id_role" value="2" >Categories Recrutement</button> 
      <input type="hidden" name="Id_page" value="ViewCategories"/>
            <input type="hidden" name="id_role" value="${requestScope.id_role }"/>
            ...
            <th>Catégories</th>
              ...
              <tbody style="width:20%">
              			  	 ...
              			  	 <c:forEach var="item" items="${requestScope.AllCatAndSousCat}" >
                <tr class="gradeX">
                        <c:choose>
                 ...
                 <c:when test="${requestScope.Id_page eq 'ViewCategories' }">
                   ...
                   <form action="Admin" method="get">
        <td><input name ="nomCategorie" type="text" value="${item.nom}"/></td>
                   
                                <td>
                   
                  <input type="submit" value="Mis ajour" />
                     <input type="hidden" name="Id_page" value="Mis_A_jourCategories"/>
                  <input type="hidden" name="id_Categorie" value="${item.id}"/>
                                   </td>
                  ...
                  <input type="hidden" name="Id_page" value="DELETECategories"/>
                  <input type="hidden" name="id_Categorie" value="${item.id}"/>
                  <%if(request.getParameter("id_role")!= null ){%>
                                    <input type="hidden" name="id_role" value="<%out.print(request.getParameter("id_role")) ;%>"/>
<%}else{     %>
    ...
    <c:when test="${requestScope.Id_page eq 'ViewSousCategories' }">
                  
                                 
               
                   <form action="Admin" method="get">
                      <td><input name ="nomSousCategorie"type="text" value="${item.nom}"/></td>
                ...
                <c:choose>
  <c:when test="${item.idCat eq itemCategoris.id}">
                  <option selected value="${itemCategoris.id}"> ${itemCategoris.nom} </option>
                    </c:when>
                  <c:otherwise>
                  <option  value="${itemCategoris.id}"> ${itemCategoris.nom} </option>
  </c:otherwise>
</c:choose>
              ...
              <td>    <input type="submit" value="Mis ajour" />
                     <input type="hidden" name="Id_page" value="Mis_A_jourSousCategories"/>
                  <input type="hidden" name="id_SousCategorie" value="${item.id }"/>
                  </td>
                   </form>
                  <td>
                  <form action="Admin" method="get">
                  <input type="submit" value="supprimer" />
                  <input type="hidden" name="Id_page" value="DELETESousCategorie"/>
                  <input type="hidden" name="id_SousCategorie" value="${item.id}"/>
                            <%if(request.getParameter("id_role")!= null ){%>
                                    <input type="hidden" name="id_role" value="<%out.print(request.getParameter("id_role")) ;%>"/>
<%}else{     %>
    ...
    <%} %>
            ...
            <c:choose>
                <c:when test="${requestScope.Id_page eq 'InsertCategories' }">
                  
                                 
               
                   <form action="Admin" method="get">
                <td>   
                 Nom:<input name ="nomCategorie"type="text" value=""/>
                 </td>
             <td> 
               ...
               <option value="2">Recrutement</option>
                ...
                <td>                                   
                <button class="btn btn-success dropdown-toggle" name ="" type="submit" >Save </button> 
                
                  
                 </td>
          <td>
                  <input type="hidden" name="Id_page" value="AjoutCategories"/>
                  </td>
                  </form>
                   </tbody>
                  ...
                  <c:when test="${requestScope.Id_page eq 'InsertSousCategories' }">
          ...
          <td>
                                    ...
                                    <input type="hidden" name="Id_page" value="AjoutSousCategories"/>
                                       <input type="hidden" name="id_role" value="${requestScope.id_role }"/>
