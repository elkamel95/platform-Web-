...
<div id="content">
    ...
    <div class="row-fluid">
      <div class="span12">
                        <c:choose>
                                ...
                                <c:when test="${requestScope.Id_page eq 'ViewSlider' }">
                                  <form action="Admin" method="get">
                  <input type="submit" value="supprimer tout" />
                <input type="hidden" name="Id_page" value="DeleteAllSlider"/>
                  
                  </form>
                  
               </c:when>
                 <c:when test="${requestScope.Id_page eq 'ViewPub' }">
                 
                  <form action="Admin" method="get">
                  <input type="submit" value="supprimer tout" />
                <input type="hidden" name="Id_page" value="DeleteAllPub"/>
          ...
          <div class="widget-content nopadding">
            ...
            <th>Image</th>
              ...
              <tbody style="width:20%">
              			  	 ...
              			  	 <c:forEach var="item" items="${requestScope.AllSlider}" >
                <tr class="gradeX">
                        <c:choose>
                
                 <c:when test="${requestScope.Id_page eq 'ViewSlider' }">
                  
                                 <td><img src="themes/images/carousel/${item.image}" alt="" /></td>
                                                   <td>${item.nom}</td>
                                 
                                    <td class="center">
                  <form action="Admin" method="get">
                  <input type="submit" value="supprimer" />
                  <input type="hidden" name="Id_page" value="DELETESlider"/>
                  <input type="hidden" name="id_Slider" value="${item.id_Slider}"/>
                  
                  </form>
                   <form action="Admin" method="get">
                  <input type="submit" value="Mis ajour" />
                     <input type="hidden" name="Id_page" value="Mis_A_jourSlider"/>
                  <input type="hidden" name="id_Slider" value="${item.id_Slider}"/>
                  </form>
                   </td>
  ...
  <tr><td>   
                         ...
                         <td><img src="themes/images/Pub/${item.image}" alt="" /></td>
                                           <td>${item.nom}</td>
                         
                            <td class="center">
                  <form action="Admin" method="get">
                  <input type="submit" value="supprimer" />
                  <input type="hidden" name="Id_page" value="DELETEPub"/>
                  <input type="hidden" name="id_Pub" value="${item.id_Slider}"/>
                  
                  </form>
               <form action="Admin" method="get">
                  <input type="submit" value="Mis ajour" />
                     <input type="hidden" name="Id_page" value="Mis_A_jourPub"/>
                  <input type="hidden" name="id_Pub" value="${item.id_Slider}"/>
                  </form>
                   </td>
  </c:when>
